...
{
    /* no semaphore (mutex protection) for this function */
...
void *idle(void *threadid)
{
    ...
    /* The code below between pthread_mutex_lock and pthread_mutex_unlock 
    ** is the critical section protected by mutex msgSem */
    CScnt++; /* Critical Section count */
...
void print_scheduler(void)
{
    ...
    /* Query the scheduling policy currently applied to the procesS */
    ...
    switch(schedType)
    {
        ...
        case SCHED_OTHER:
            ...
            break;
        case SCHED_RR:
            printf("Pthread Policy is SCHED_ROUNDROBIN\n");
            break;
        default:
...
int main (int argc, char *argv[])
{
    ...
    /* Initialize the mutex using default attributes */
